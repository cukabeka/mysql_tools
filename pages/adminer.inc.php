  ...
  echo '
    <div class="rex-addon-output" style="display:none;">
      <div class="rex-form">
        ...
        <form id="openadminer" action="'.$REX['SERVER'].'/redaxo/include/addons/'.$mypage.'/libs/adminer-3.6.1/adminer/index.php" method="POST" target="adminer_'.$_REQUEST['PHPSESSID'].'">
